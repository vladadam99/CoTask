...
const sections = [
  {
    ...
    content: `CoTask is a tech company that provides an online platform where independent contractors ("Avatars") and clients can connect to arrange for the performance of remote presence and task-based assignments. CoTask is operated by CoTask Ltd, registered in the United Kingdom.`,
  },
  {
    title: '2. How Does CoTask Work?',
    content: `Clients can post a job or booking on the CoTask platform. Avatars can respond to these opportunities, and both parties agree on the terms under which the Avatar will provide services. If an agreement is reached, they enter into a contract with each other. CoTask is not a party to that agreement — we only facilitate the connection.`,
  },
  {
    title: "3. CoTask's Role",
    content: `CoTask ensures that Avatars and clients can find each other and facilitates the arrangement of assignments. CoTask does not manage or give instructions to Avatars, does not monitor the implementation of assignments, and does not in any way determine how, when, or by whom work is performed. These are matters you agree upon with the client.`,
  },
  {
    title: '4. Role of the Avatar',
    content: `As an Avatar on CoTask, you are an independent self-employed contractor. You are responsible for arranging assignments and making agreements with clients. You have multiple clients (variable income), you determine how you carry out work, and you comply with all rules applicable to independent contractors in your jurisdiction. You have the absolute right not to respond to any opportunity and are under no obligation to accept any work.`,
  },
  {
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Welcome to CoTask. These terms govern the relationship between CoTask and all users of the platform — both clients and Avatars. Please read them carefully. By using CoTask, you agree to these terms.
          </p>
