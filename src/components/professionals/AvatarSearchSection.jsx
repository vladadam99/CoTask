            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                  Create one clear task and let qualified agents respond before you fund Secure Payment.
                </p>
              </div>
            </div>
            <Button asChild className="mt-4 w-full">
              <Link to="/PostJob">New Task</Link>
            </Button>
          </div>
        </aside>
          ...
          {isLoading ? (
            ...
            <div className="surface-panel rounded-lg px-6 py-16 text-center">
              ...
              <div className="mt-5 flex flex-col justify-center gap-2 sm:flex-row">
                ...
                <Button asChild><Link to="/PostJob">New Task</Link></Button>
              </div>
            </div>
          ) : (
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
